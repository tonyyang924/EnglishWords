...
public class GlobalPreference implements IPreference {
    ...
    static final String FLAG_PERMISSIONS_STORAGE = "flag_permissions_storage";

    static IPreference getPreference(Context context) {
        synchronized (lock) {
            if (iPreference == null) {
    ...
    private GlobalPreference(Context context, String fileName) {
